...
/**
 * Implementations of this listener may be registered with instances of rvg.sv.LOM to 
...
public interface LOMListener extends com.ibm.adtech.jastor.ThingListener {
	 ...
	 * @param source the affected instance of rvg.sv.LOM
	 ...
	 * @param newValue the object representing the new value
	 */	
	public void lomMetaMetadataAdded(LOM source, rvg.sv.Meta_DASH_Metadata newValue);
	 ...
	 * @param oldValue the object representing the removed value
	 */
	public void lomMetaMetadataRemoved(LOM source, rvg.sv.Meta_DASH_Metadata oldValue);
